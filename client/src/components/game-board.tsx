...
export default function GameBoard({
  ...
  return (
    <div className="mb-8 relative overflow-visible gwan-board-container p-4 z-0 game-board-container">
      <div className={`game-board-3d ${isOpponent ? 'opponent-field-3d' : 'player-field-3d'}`}>
        <div className="flex justify-between items-center mb-4 relative z-10">
          ...
          <div className="flex items-center relative score-display-3d">
              ...
              <AnimatePresence>
                {showScoreAnimation && !isOpponent && (
                  <motion.div
                    ...
                    exit={{ opacity: 0 }}
                    className={cn(
                      "absolute -right-2 -top-16 px-3 py-2 rounded-md font-bold text-white z-[100]",
        ...
        <div className="space-y-4">
          {rowOrder.map((rowKey) => (
            <div key={`${isOpponent ? "op" : "pl"}-${rowKey}-row`} className="flex items-center">
              ...
              <motion.div 
                className={`game-row card-row-3d flex-1 h-20 flex items-center p-2 pt-5 rounded-lg relative
                    ...
                    >
                      {currentPlayer.field[rowKey].map((card, index) => (
                        <motion.div 
                          ...
                          className="mx-1 relative group card-3d"
