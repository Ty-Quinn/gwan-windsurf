...
export default function MainMenu() {
  ...
  const handlePlayOnlineMatch = () => {
    // In a real app, this would start matchmaking or join a lobby
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#1a0f0b] to-[#2a1a14] text-amber-100 flex flex-col">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-0 left-0 w-full h-full opacity-5 bg-repeat"></div>
          ...
          <Card className="bg-black/30 backdrop-blur-md border border-amber-900/50 p-8 rounded-xl shadow-[0_0_15px_rgba(245,158,11,0.1)] overflow-hidden relative">
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col gap-5">
                <Button 
                  className="h-20 text-xl bg-gradient-to-r from-amber-800 to-amber-700 hover:from-amber-700 hover:to-amber-600 text-amber-100 border-none rounded-xl flex items-center justify-center gap-3 shadow-lg transition-all duration-300 hover:translate-y-[-2px]"
                  onClick={handlePlayOnlineMatch}
                >
                ...
                <Button 
                  className="h-20 text-xl bg-gradient-to-r from-amber-900 to-amber-800 hover:from-amber-800 hover:to-amber-700 text-amber-100 border-none rounded-xl flex items-center justify-center gap-3 shadow-lg transition-all duration-300 hover:translate-y-[-2px]"
